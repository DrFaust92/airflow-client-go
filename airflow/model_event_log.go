...
type EventLog struct {
	...
	// The Try Number
	TryNumber NullableInt32 `json:"try_number,omitempty"`
...
func (o *EventLog) SetMapIndexNil() {
	o.MapIndex.Set(nil)
}
...
// GetTryNumber returns the TryNumber field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EventLog) GetTryNumber() int32 {
	if o == nil || IsNil(o.TryNumber.Get()) {
		var ret int32
		return ret
	}
...
// SetTryNumber gets a reference to the given NullableInt32 and assigns it to the TryNumber field.
func (o *EventLog) SetTryNumber(v int32) {
	o.TryNumber.Set(&v)
}
// SetTryNumberNil sets the value for TryNumber to be an explicit nil
func (o *EventLog) SetTryNumberNil() {
	o.TryNumber.Set(nil)
}
