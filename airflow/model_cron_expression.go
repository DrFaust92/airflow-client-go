...
// checks if the CronExpression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CronExpression{}
...
type _CronExpression CronExpression
...
func (o CronExpression) ToMap() (map[string]interface{}, error) {
...
func (o *CronExpression) UnmarshalJSON(data []byte) (err error) {
	...
	varCronExpression := _CronExpression{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCronExpression)

	if err != nil {
		return err
	}

	*o = CronExpression(varCronExpression)
