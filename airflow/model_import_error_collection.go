...
// checks if the ImportErrorCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportErrorCollection{}
...
func (o ImportErrorCollection) ToMap() (map[string]interface{}, error) {
