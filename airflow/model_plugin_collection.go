...
// checks if the PluginCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginCollection{}
...
func (o PluginCollection) ToMap() (map[string]interface{}, error) {
