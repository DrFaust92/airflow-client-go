...
// checks if the CreateDatasetEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDatasetEvent{}

// CreateDatasetEvent struct for CreateDatasetEvent
...
type _CreateDatasetEvent CreateDatasetEvent
...
// GetDatasetUri returns the DatasetUri field value
...
// GetDatasetUriOk returns a tuple with the DatasetUri field value
...
// SetDatasetUri sets field value
...
func (o CreateDatasetEvent) MarshalJSON() ([]byte, error) {
...
func (o CreateDatasetEvent) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDatasetEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDatasetEvent := _CreateDatasetEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateDatasetEvent)

	if err != nil {
		return err
	}

	*o = CreateDatasetEvent(varCreateDatasetEvent)

	return err
}

type NullableCreateDatasetEvent struct {
	value *CreateDatasetEvent
	isSet bool
}

func (v NullableCreateDatasetEvent) Get() *CreateDatasetEvent {
	return v.value
}

func (v *NullableCreateDatasetEvent) Set(val *CreateDatasetEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDatasetEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDatasetEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDatasetEvent(val *CreateDatasetEvent) *NullableCreateDatasetEvent {
	return &NullableCreateDatasetEvent{value: val, isSet: true}
}

func (v NullableCreateDatasetEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDatasetEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
