...
// checks if the DAGDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DAGDetail{}
...
type DAGDetail struct {
	...
	MaxConsecutiveFailedDagRuns NullableInt32 `json:"max_consecutive_failed_dag_runs,omitempty"`
	...
	Catchup NullableBool `json:"catchup,omitempty"`
	Concurrency NullableFloat32 `json:"concurrency,omitempty"`
...
func (o *DAGDetail) GetDefaultView() string {
	if o == nil || IsNil(o.DefaultView.Get()) {
		var ret string
		return ret
	}
...
func (o *DAGDetail) SetDefaultViewNil() {
...
func (o *DAGDetail) GetHasImportErrors() bool {
	if o == nil || IsNil(o.HasImportErrors.Get()) {
		var ret bool
		return ret
	}
...
func (o *DAGDetail) GetHasTaskConcurrencyLimits() bool {
	if o == nil || IsNil(o.HasTaskConcurrencyLimits.Get()) {
		var ret bool
		return ret
	}
...
func (o *DAGDetail) GetLastExpired() time.Time {
	if o == nil || IsNil(o.LastExpired.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetLastParsedTime() time.Time {
	if o == nil || IsNil(o.LastParsedTime.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetLastPickled() time.Time {
	if o == nil || IsNil(o.LastPickled.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetMaxActiveRuns() int32 {
	if o == nil || IsNil(o.MaxActiveRuns.Get()) {
		var ret int32
		return ret
	}
...
func (o *DAGDetail) GetMaxActiveTasks() int32 {
	if o == nil || IsNil(o.MaxActiveTasks.Get()) {
		var ret int32
		return ret
	}
...
// GetMaxConsecutiveFailedDagRuns returns the MaxConsecutiveFailedDagRuns field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DAGDetail) GetMaxConsecutiveFailedDagRuns() int32 {
	if o == nil || IsNil(o.MaxConsecutiveFailedDagRuns.Get()) {
		var ret int32
		return ret
	}
	return *o.MaxConsecutiveFailedDagRuns.Get()
}

// GetMaxConsecutiveFailedDagRunsOk returns a tuple with the MaxConsecutiveFailedDagRuns field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DAGDetail) GetMaxConsecutiveFailedDagRunsOk() (*int32, bool) {
	...
	return o.MaxConsecutiveFailedDagRuns.Get(), o.MaxConsecutiveFailedDagRuns.IsSet()
}
...
func (o *DAGDetail) HasMaxConsecutiveFailedDagRuns() bool {
	if o != nil && o.MaxConsecutiveFailedDagRuns.IsSet() {
		return true
	}
...
// SetMaxConsecutiveFailedDagRuns gets a reference to the given NullableInt32 and assigns it to the MaxConsecutiveFailedDagRuns field.
func (o *DAGDetail) SetMaxConsecutiveFailedDagRuns(v int32) {
	o.MaxConsecutiveFailedDagRuns.Set(&v)
}
// SetMaxConsecutiveFailedDagRunsNil sets the value for MaxConsecutiveFailedDagRuns to be an explicit nil
func (o *DAGDetail) SetMaxConsecutiveFailedDagRunsNil() {
	o.MaxConsecutiveFailedDagRuns.Set(nil)
}
...
func (o *DAGDetail) UnsetMaxConsecutiveFailedDagRuns() {
	o.MaxConsecutiveFailedDagRuns.Unset()
}
...
func (o *DAGDetail) GetNextDagrun() time.Time {
	if o == nil || IsNil(o.NextDagrun.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetNextDagrunCreateAfter() time.Time {
	if o == nil || IsNil(o.NextDagrunCreateAfter.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetNextDagrunDataIntervalEnd() time.Time {
	if o == nil || IsNil(o.NextDagrunDataIntervalEnd.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetNextDagrunDataIntervalStart() time.Time {
	if o == nil || IsNil(o.NextDagrunDataIntervalStart.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) GetRootDagId() string {
	if o == nil || IsNil(o.RootDagId.Get()) {
		var ret string
		return ret
	}
...
func (o *DAGDetail) GetScheduleInterval() ScheduleInterval {
	if o == nil || IsNil(o.ScheduleInterval.Get()) {
...
func (o *DAGDetail) GetSchedulerLock() bool {
	if o == nil || IsNil(o.SchedulerLock.Get()) {
		var ret bool
		return ret
	}
...
func (o *DAGDetail) GetTimetableDescription() string {
	if o == nil || IsNil(o.TimetableDescription.Get()) {
		var ret string
		return ret
	}
...
// GetCatchup returns the Catchup field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DAGDetail) GetCatchup() bool {
	if o == nil || IsNil(o.Catchup.Get()) {
		var ret bool
		return ret
	}
	return *o.Catchup.Get()
}
...
// SetCatchup gets a reference to the given NullableBool and assigns it to the Catchup field.
func (o *DAGDetail) SetCatchup(v bool) {
	o.Catchup.Set(&v)
}
// SetCatchupNil sets the value for Catchup to be an explicit nil
func (o *DAGDetail) SetCatchupNil() {
	o.Catchup.Set(nil)
}
...
// SetConcurrency gets a reference to the given NullableFloat32 and assigns it to the Concurrency field.
func (o *DAGDetail) SetConcurrency(v float32) {
	o.Concurrency.Set(&v)
}
// SetConcurrencyNil sets the value for Concurrency to be an explicit nil
func (o *DAGDetail) SetConcurrencyNil() {
...
func (o *DAGDetail) GetDagRunTimeout() TimeDelta {
	if o == nil || IsNil(o.DagRunTimeout.Get()) {
		var ret TimeDelta
		return ret
	}
...
// GetDatasetExpression returns the DatasetExpression field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *DAGDetail) GetDatasetExpression() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.DatasetExpression
}

// GetDatasetExpressionOk returns a tuple with the DatasetExpression field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DAGDetail) GetDatasetExpressionOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.DatasetExpression) {
		return map[string]interface{}{}, false
	}
	return o.DatasetExpression, true
}
...
// SetDatasetExpression gets a reference to the given map[string]interface{} and assigns it to the DatasetExpression field.
func (o *DAGDetail) SetDatasetExpression(v map[string]interface{}) {
	o.DatasetExpression = v
}
...
func (o *DAGDetail) GetIsPausedUponCreation() bool {
	if o == nil || IsNil(o.IsPausedUponCreation.Get()) {
		var ret bool
		return ret
	}
...
func (o *DAGDetail) GetLastParsed() time.Time {
	if o == nil || IsNil(o.LastParsed.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *DAGDetail) SetOrientationNil() {
...
func (o *DAGDetail) GetRenderTemplateAsNativeObj() bool {
	if o == nil || IsNil(o.RenderTemplateAsNativeObj.Get()) {
		var ret bool
		return ret
	}
...
func (o DAGDetail) ToMap() (map[string]interface{}, error) {
	...
	if o.MaxConsecutiveFailedDagRuns.IsSet() {
		toSerialize["max_consecutive_failed_dag_runs"] = o.MaxConsecutiveFailedDagRuns.Get()
	}
	...
	if o.Catchup.IsSet() {
		toSerialize["catchup"] = o.Catchup.Get()
	}
	...
	if o.DatasetExpression != nil {
		toSerialize["dataset_expression"] = o.DatasetExpression
	}
	if o.DocMd.IsSet() {
