...
// checks if the XComCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XComCollection{}
...
func (o XComCollection) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TotalEntries) {
		toSerialize["total_entries"] = o.TotalEntries
	}
	if !IsNil(o.XcomEntries) {
