...
// checks if the TaskCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskCollection{}
...
func (o TaskCollection) ToMap() (map[string]interface{}, error) {
