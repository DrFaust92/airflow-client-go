...
// checks if the XComCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XComCollectionItem{}
...
func (o XComCollectionItem) ToMap() (map[string]interface{}, error) {
