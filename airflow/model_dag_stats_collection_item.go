...
// checks if the DagStatsCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagStatsCollectionItem{}
...
func (o *DagStatsCollectionItem) GetStats() []DagStatsStateCollectionItem {
	if o == nil {
		var ret []DagStatsStateCollectionItem
		return ret
	}
	return o.Stats
}
...
// SetStats gets a reference to the given []DagStatsStateCollectionItem and assigns it to the Stats field.
func (o *DagStatsCollectionItem) SetStats(v []DagStatsStateCollectionItem) {
	o.Stats = v
}

func (o DagStatsCollectionItem) MarshalJSON() ([]byte, error) {
...
func (o DagStatsCollectionItem) ToMap() (map[string]interface{}, error) {
...
type NullableDagStatsCollectionItem struct {
	value *DagStatsCollectionItem
	isSet bool
}

func (v NullableDagStatsCollectionItem) Get() *DagStatsCollectionItem {
	return v.value
}

func (v *NullableDagStatsCollectionItem) Set(val *DagStatsCollectionItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDagStatsCollectionItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDagStatsCollectionItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDagStatsCollectionItem(val *DagStatsCollectionItem) *NullableDagStatsCollectionItem {
	return &NullableDagStatsCollectionItem{value: val, isSet: true}
}

func (v NullableDagStatsCollectionItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDagStatsCollectionItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
