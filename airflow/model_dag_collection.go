...
// checks if the DAGCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DAGCollection{}
...
func (o DAGCollection) ToMap() (map[string]interface{}, error) {
