...
// checks if the TaskInstanceReferenceCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstanceReferenceCollection{}
...
func (o *TaskInstanceReferenceCollection) GetTaskInstances() []TaskInstanceReference {
	if o == nil || IsNil(o.TaskInstances) {
...
func (o TaskInstanceReferenceCollection) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TaskInstances) {
