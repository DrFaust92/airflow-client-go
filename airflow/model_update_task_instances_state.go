...
// checks if the UpdateTaskInstancesState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTaskInstancesState{}
...
// SetNewState gets a reference to the given UpdateTaskState and assigns it to the NewState field.
...
func (o UpdateTaskInstancesState) ToMap() (map[string]interface{}, error) {
