...
// checks if the SetTaskInstanceNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetTaskInstanceNote{}
...
type _SetTaskInstanceNote SetTaskInstanceNote
...
func (o SetTaskInstanceNote) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["note"] = o.Note
	return toSerialize, nil
}

func (o *SetTaskInstanceNote) UnmarshalJSON(data []byte) (err error) {
	...
	varSetTaskInstanceNote := _SetTaskInstanceNote{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetTaskInstanceNote)

	if err != nil {
		return err
	}

	*o = SetTaskInstanceNote(varSetTaskInstanceNote)
