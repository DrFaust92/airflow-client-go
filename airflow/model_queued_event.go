...
// checks if the QueuedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueuedEvent{}

// QueuedEvent struct for QueuedEvent
...
func (o QueuedEvent) MarshalJSON() ([]byte, error) {
...
func (o QueuedEvent) ToMap() (map[string]interface{}, error) {
...
type NullableQueuedEvent struct {
	value *QueuedEvent
	isSet bool
}

func (v NullableQueuedEvent) Get() *QueuedEvent {
	return v.value
}

func (v *NullableQueuedEvent) Set(val *QueuedEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableQueuedEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableQueuedEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueuedEvent(val *QueuedEvent) *NullableQueuedEvent {
	return &NullableQueuedEvent{value: val, isSet: true}
}

func (v NullableQueuedEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueuedEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
