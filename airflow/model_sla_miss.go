...
// checks if the SLAMiss type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SLAMiss{}
...
func (o SLAMiss) ToMap() (map[string]interface{}, error) {
