...
// checks if the PluginCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginCollectionItem{}
...
func (o *PluginCollectionItem) GetAppbuilderMenuItems() []*map[string]interface{} {
	if o == nil || IsNil(o.AppbuilderMenuItems) {
...
func (o *PluginCollectionItem) GetAppbuilderViews() []*map[string]interface{} {
	if o == nil || IsNil(o.AppbuilderViews) {
		var ret []*map[string]interface{}
		return ret
	}
...
// SetFlaskBlueprints gets a reference to the given []*string and assigns it to the FlaskBlueprints field.
...
func (o *PluginCollectionItem) GetGlobalOperatorExtraLinks() []*string {
	if o == nil || IsNil(o.GlobalOperatorExtraLinks) {
		var ret []*string
		return ret
	}
...
// SetGlobalOperatorExtraLinks gets a reference to the given []*string and assigns it to the GlobalOperatorExtraLinks field.
...
// SetMacros gets a reference to the given []*string and assigns it to the Macros field.
...
func (o *PluginCollectionItem) GetOperatorExtraLinks() []*string {
	if o == nil || IsNil(o.OperatorExtraLinks) {
		var ret []*string
		return ret
	}
...
// SetOperatorExtraLinks gets a reference to the given []*string and assigns it to the OperatorExtraLinks field.
...
// GetTiDeps returns the TiDeps field value if set, zero value otherwise.
func (o *PluginCollectionItem) GetTiDeps() []string {
	if o == nil || IsNil(o.TiDeps) {
		var ret []string
		return ret
	}
	return o.TiDeps
...
// GetTiDepsOk returns a tuple with the TiDeps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PluginCollectionItem) GetTiDepsOk() ([]string, bool) {
	if o == nil || IsNil(o.TiDeps) {
		return nil, false
	}
	return o.TiDeps, true
}
...
// SetTiDeps gets a reference to the given []string and assigns it to the TiDeps field.
...
// SetTimetables gets a reference to the given []string and assigns it to the Timetables field.
