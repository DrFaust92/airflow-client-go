...
// checks if the DAGRunCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DAGRunCollection{}
...
func (o DAGRunCollection) ToMap() (map[string]interface{}, error) {
