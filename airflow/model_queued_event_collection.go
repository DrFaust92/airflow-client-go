...
// checks if the QueuedEventCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueuedEventCollection{}

// QueuedEventCollection A collection of Dataset Dag Run Queues.  *New in version 2.9.0* 
...
// SetDatasets gets a reference to the given []QueuedEvent and assigns it to the Datasets field.
func (o *QueuedEventCollection) SetDatasets(v []QueuedEvent) {
	o.Datasets = v
}

func (o QueuedEventCollection) MarshalJSON() ([]byte, error) {
...
func (o QueuedEventCollection) ToMap() (map[string]interface{}, error) {
...
type NullableQueuedEventCollection struct {
	value *QueuedEventCollection
	isSet bool
}

func (v NullableQueuedEventCollection) Get() *QueuedEventCollection {
	return v.value
}

func (v *NullableQueuedEventCollection) Set(val *QueuedEventCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableQueuedEventCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableQueuedEventCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueuedEventCollection(val *QueuedEventCollection) *NullableQueuedEventCollection {
	return &NullableQueuedEventCollection{value: val, isSet: true}
}

func (v NullableQueuedEventCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueuedEventCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
