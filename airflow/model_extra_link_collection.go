...
// checks if the ExtraLinkCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtraLinkCollection{}
...
func (o ExtraLinkCollection) ToMap() (map[string]interface{}, error) {
