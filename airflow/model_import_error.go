...
// checks if the ImportError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportError{}
...
func (o *ImportError) GetImportErrorId() int32 {
	if o == nil || IsNil(o.ImportErrorId) {
		var ret int32
		return ret
	}
...
func (o ImportError) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Filename) {
		toSerialize["filename"] = o.Filename
	}
	if !IsNil(o.ImportErrorId) {
