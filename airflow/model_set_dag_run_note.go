...
// checks if the SetDagRunNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetDagRunNote{}
...
func (o SetDagRunNote) ToMap() (map[string]interface{}, error) {
