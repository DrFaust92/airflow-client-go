...
// checks if the TaskInstanceDependencyCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstanceDependencyCollection{}

// TaskInstanceDependencyCollection struct for TaskInstanceDependencyCollection
...
func NewTaskInstanceDependencyCollection() *TaskInstanceDependencyCollection {
	this := TaskInstanceDependencyCollection{}
	return &this
}
...
// SetDependencies gets a reference to the given []TaskFailedDependency and assigns it to the Dependencies field.
func (o *TaskInstanceDependencyCollection) SetDependencies(v []TaskFailedDependency) {
	o.Dependencies = v
}

func (o TaskInstanceDependencyCollection) MarshalJSON() ([]byte, error) {
...
func (o TaskInstanceDependencyCollection) ToMap() (map[string]interface{}, error) {
...
type NullableTaskInstanceDependencyCollection struct {
	value *TaskInstanceDependencyCollection
	isSet bool
}

func (v NullableTaskInstanceDependencyCollection) Get() *TaskInstanceDependencyCollection {
	return v.value
}

func (v *NullableTaskInstanceDependencyCollection) Set(val *TaskInstanceDependencyCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskInstanceDependencyCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskInstanceDependencyCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskInstanceDependencyCollection(val *TaskInstanceDependencyCollection) *NullableTaskInstanceDependencyCollection {
	return &NullableTaskInstanceDependencyCollection{value: val, isSet: true}
}

func (v NullableTaskInstanceDependencyCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskInstanceDependencyCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
