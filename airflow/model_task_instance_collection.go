...
// checks if the TaskInstanceCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstanceCollection{}
...
func (o TaskInstanceCollection) ToMap() (map[string]interface{}, error) {
