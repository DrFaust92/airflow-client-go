...
// checks if the TaskInstanceReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstanceReference{}
...
func (o TaskInstanceReference) ToMap() (map[string]interface{}, error) {
