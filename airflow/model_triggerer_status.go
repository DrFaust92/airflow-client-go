...
// checks if the TriggererStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggererStatus{}
...
func (o *TriggererStatus) GetLatestTriggererHeartbeat() string {
	if o == nil || IsNil(o.LatestTriggererHeartbeat.Get()) {
		var ret string
		return ret
	}
...
func (o TriggererStatus) ToMap() (map[string]interface{}, error) {
