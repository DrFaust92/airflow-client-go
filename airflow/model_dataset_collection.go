...
// checks if the DatasetCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetCollection{}
...
func (o DatasetCollection) ToMap() (map[string]interface{}, error) {
