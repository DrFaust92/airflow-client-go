...
// checks if the SchedulerStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulerStatus{}
...
func (o *SchedulerStatus) GetLatestSchedulerHeartbeat() string {
	if o == nil || IsNil(o.LatestSchedulerHeartbeat.Get()) {
		var ret string
		return ret
	}
...
func (o SchedulerStatus) ToMap() (map[string]interface{}, error) {
