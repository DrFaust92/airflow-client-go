...
// checks if the VariableCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariableCollection{}
...
func (o VariableCollection) ToMap() (map[string]interface{}, error) {
