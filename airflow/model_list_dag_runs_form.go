...
// checks if the ListDagRunsForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDagRunsForm{}
...
func (o ListDagRunsForm) ToMap() (map[string]interface{}, error) {
