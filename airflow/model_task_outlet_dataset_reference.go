...
// checks if the TaskOutletDatasetReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskOutletDatasetReference{}
...
func (o TaskOutletDatasetReference) ToMap() (map[string]interface{}, error) {
