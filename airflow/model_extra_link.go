...
// checks if the ExtraLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtraLink{}
...
func (o ExtraLink) ToMap() (map[string]interface{}, error) {
