...
// checks if the DagProcessorStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagProcessorStatus{}
...
func (o *DagProcessorStatus) GetLatestDagProcessorHeartbeat() string {
	if o == nil || IsNil(o.LatestDagProcessorHeartbeat.Get()) {
		var ret string
		return ret
	}
...
func (o DagProcessorStatus) ToMap() (map[string]interface{}, error) {
