...
type Connection struct {
	...
	// Team name for Airflow 3 multi-team deployments.
...
func (o *Connection) GetTeamName() string {
...
// and a boolean to check if the value has been set.
func (o *Connection) GetTeamNameOk() (*string, bool) {
	if o == nil || o.TeamName == nil {
		return nil, false
	}
...
func (o *Connection) HasTeamName() bool {
	if o != nil && o.TeamName != nil {
		return true
	}
...
func (o *Connection) SetTeamName(v string) {
	o.TeamName = &v
}
