...
// checks if the DagWarning type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagWarning{}
...
func (o DagWarning) ToMap() (map[string]interface{}, error) {
