...
// checks if the MetadatabaseStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadatabaseStatus{}
...
func (o MetadatabaseStatus) ToMap() (map[string]interface{}, error) {
