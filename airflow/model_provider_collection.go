...
// checks if the ProviderCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProviderCollection{}
...
func (o ProviderCollection) ToMap() (map[string]interface{}, error) {
