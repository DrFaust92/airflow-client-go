...
// checks if the DatasetEventCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetEventCollection{}
...
func (o *DatasetEventCollection) GetDatasetEvents() []DatasetEvent {
	if o == nil || IsNil(o.DatasetEvents) {
...
func (o DatasetEventCollection) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TotalEntries) {
		toSerialize["total_entries"] = o.TotalEntries
	}
	if !IsNil(o.DatasetEvents) {
