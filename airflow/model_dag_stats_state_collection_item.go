...
// checks if the DagStatsStateCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagStatsStateCollectionItem{}
...
func NewDagStatsStateCollectionItem() *DagStatsStateCollectionItem {
	this := DagStatsStateCollectionItem{}
	return &this
}
...
func (o DagStatsStateCollectionItem) MarshalJSON() ([]byte, error) {
...
func (o DagStatsStateCollectionItem) ToMap() (map[string]interface{}, error) {
...
type NullableDagStatsStateCollectionItem struct {
	value *DagStatsStateCollectionItem
	isSet bool
}

func (v NullableDagStatsStateCollectionItem) Get() *DagStatsStateCollectionItem {
	return v.value
}

func (v *NullableDagStatsStateCollectionItem) Set(val *DagStatsStateCollectionItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDagStatsStateCollectionItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDagStatsStateCollectionItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDagStatsStateCollectionItem(val *DagStatsStateCollectionItem) *NullableDagStatsStateCollectionItem {
	return &NullableDagStatsStateCollectionItem{value: val, isSet: true}
}

func (v NullableDagStatsStateCollectionItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDagStatsStateCollectionItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
