...
// checks if the TaskInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstance{}
...
type TaskInstance struct {
	...
	RenderedMapIndex NullableString `json:"rendered_map_index,omitempty"`
...
// GetRenderedMapIndex returns the RenderedMapIndex field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskInstance) GetRenderedMapIndex() string {
	if o == nil || IsNil(o.RenderedMapIndex.Get()) {
		var ret string
		return ret
	}
...
// GetRenderedMapIndexOk returns a tuple with the RenderedMapIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *TaskInstance) HasRenderedMapIndex() bool {
	if o != nil && o.RenderedMapIndex.IsSet() {
		return true
	}
...
// SetRenderedMapIndex gets a reference to the given NullableString and assigns it to the RenderedMapIndex field.
...
func (o *TaskInstance) SetRenderedMapIndexNil() {
	o.RenderedMapIndex.Set(nil)
}
...
func (o *TaskInstance) GetTriggererJob() Job {
	if o == nil || IsNil(o.TriggererJob.Get()) {
		var ret Job
		return ret
	}
...
func (o TaskInstance) ToMap() (map[string]interface{}, error) {
