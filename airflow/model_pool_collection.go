...
// checks if the PoolCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolCollection{}
...
func (o PoolCollection) ToMap() (map[string]interface{}, error) {
