...
const (
	...
	ALL_DONE_SETUP_SUCCESS TriggerRule = "all_done_setup_success"
	ONE_SUCCESS TriggerRule = "one_success"
	ONE_FAILED TriggerRule = "one_failed"
	ONE_DONE TriggerRule = "one_done"
	...
	ALL_SKIPPED TriggerRule = "all_skipped"
