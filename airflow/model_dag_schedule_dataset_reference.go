...
// checks if the DagScheduleDatasetReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagScheduleDatasetReference{}
...
func (o DagScheduleDatasetReference) ToMap() (map[string]interface{}, error) {
