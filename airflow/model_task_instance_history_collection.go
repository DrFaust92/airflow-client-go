...
// checks if the TaskInstanceHistoryCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskInstanceHistoryCollection{}

// TaskInstanceHistoryCollection Collection of task instances .  *Changed in version 2.1.0*&#58; 'total_entries' field is added. 
...
// GetTaskInstancesHistory returns the TaskInstancesHistory field value if set, zero value otherwise.
func (o *TaskInstanceHistoryCollection) GetTaskInstancesHistory() []TaskInstanceHistory {
	if o == nil || IsNil(o.TaskInstancesHistory) {
		var ret []TaskInstanceHistory
		return ret
	}
	return o.TaskInstancesHistory
}

// GetTaskInstancesHistoryOk returns a tuple with the TaskInstancesHistory field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TaskInstanceHistoryCollection) GetTaskInstancesHistoryOk() ([]TaskInstanceHistory, bool) {
	if o == nil || IsNil(o.TaskInstancesHistory) {
		return nil, false
	}
	return o.TaskInstancesHistory, true
}
...
// SetTaskInstancesHistory gets a reference to the given []TaskInstanceHistory and assigns it to the TaskInstancesHistory field.
func (o *TaskInstanceHistoryCollection) SetTaskInstancesHistory(v []TaskInstanceHistory) {
	o.TaskInstancesHistory = v
}

func (o TaskInstanceHistoryCollection) MarshalJSON() ([]byte, error) {
...
func (o TaskInstanceHistoryCollection) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TotalEntries) {
		toSerialize["total_entries"] = o.TotalEntries
	}
	if !IsNil(o.TaskInstancesHistory) {
		toSerialize["task_instances_history"] = o.TaskInstancesHistory
	}
	return toSerialize, nil
}

type NullableTaskInstanceHistoryCollection struct {
	value *TaskInstanceHistoryCollection
	isSet bool
}

func (v NullableTaskInstanceHistoryCollection) Get() *TaskInstanceHistoryCollection {
	return v.value
}

func (v *NullableTaskInstanceHistoryCollection) Set(val *TaskInstanceHistoryCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskInstanceHistoryCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskInstanceHistoryCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskInstanceHistoryCollection(val *TaskInstanceHistoryCollection) *NullableTaskInstanceHistoryCollection {
	return &NullableTaskInstanceHistoryCollection{value: val, isSet: true}
}

func (v NullableTaskInstanceHistoryCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskInstanceHistoryCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
