...
type ApiGetValueRequest struct {
	ctx context.Context
	ApiService *ConfigAPIService
	section string
	option string
...
func (r ApiGetValueRequest) Execute() (*Config, *http.Response, error) {
...
GetValue Get a option from configuration
 ...
 @param section
 @param option
 @return ApiGetValueRequest
*/
func (a *ConfigAPIService) GetValue(ctx context.Context, section string, option string) ApiGetValueRequest {
	return ApiGetValueRequest{
		ApiService: a,
		ctx: ctx,
		section: section,
...
// Execute executes the request
//  @return Config
func (a *ConfigAPIService) GetValueExecute(r ApiGetValueRequest) (*Config, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
