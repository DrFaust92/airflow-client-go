...
func (r ApiGetDagStatsRequest) Execute() (*DagStatsCollectionSchema, *http.Response, error) {
...
//  @return DagStatsCollectionSchema
func (a *DagStatsAPIService) GetDagStatsExecute(r ApiGetDagStatsRequest) (*DagStatsCollectionSchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DagStatsCollectionSchema
	)
	...
	localVarPath := localBasePath + "/dagStats"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dagIds == nil {
		return localVarReturnValue, nil, reportError("dagIds is required and must be specified")
	}
