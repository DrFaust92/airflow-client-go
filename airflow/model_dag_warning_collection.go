...
// checks if the DagWarningCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagWarningCollection{}
...
// GetDagWarnings returns the DagWarnings field value if set, zero value otherwise.
func (o *DagWarningCollection) GetDagWarnings() []DagWarning {
	if o == nil || IsNil(o.DagWarnings) {
		var ret []DagWarning
		return ret
	}
...
// GetDagWarningsOk returns a tuple with the DagWarnings field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDagWarnings gets a reference to the given []DagWarning and assigns it to the DagWarnings field.
...
func (o DagWarningCollection) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TotalEntries) {
		toSerialize["total_entries"] = o.TotalEntries
	}
	if !IsNil(o.DagWarnings) {
