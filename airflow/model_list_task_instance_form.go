...
// checks if the ListTaskInstanceForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTaskInstanceForm{}
...
func (o *ListTaskInstanceForm) GetExecutionDateGte() time.Time {
	if o == nil || IsNil(o.ExecutionDateGte) {
		var ret time.Time
		return ret
	}
...
func (o *ListTaskInstanceForm) GetExecutionDateLte() time.Time {
	if o == nil || IsNil(o.ExecutionDateLte) {
		var ret time.Time
		return ret
	}
...
func (o ListTaskInstanceForm) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExecutionDateGte) {
		toSerialize["execution_date_gte"] = o.ExecutionDateGte
	}
	if !IsNil(o.ExecutionDateLte) {
