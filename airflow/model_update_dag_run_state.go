...
// checks if the UpdateDagRunState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDagRunState{}
...
func (o UpdateDagRunState) ToMap() (map[string]interface{}, error) {
