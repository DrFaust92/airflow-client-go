...
// checks if the ClearDagRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearDagRun{}
...
func (o ClearDagRun) ToMap() (map[string]interface{}, error) {
