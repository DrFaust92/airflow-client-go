...
// checks if the DAGRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DAGRun{}
...
func (o *DAGRun) GetExternalTrigger() bool {
	if o == nil || IsNil(o.ExternalTrigger) {
		var ret bool
		return ret
	}
...
func (o *DAGRun) GetLastSchedulingDecision() time.Time {
	if o == nil || IsNil(o.LastSchedulingDecision.Get()) {
		var ret time.Time
		return ret
	}
...
func (o DAGRun) ToMap() (map[string]interface{}, error) {
