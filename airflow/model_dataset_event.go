...
// checks if the DatasetEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatasetEvent{}
...
func (o *DatasetEvent) GetCreatedDagruns() []BasicDAGRun {
	if o == nil || IsNil(o.CreatedDagruns) {
		var ret []BasicDAGRun
		return ret
	}
...
func (o *DatasetEvent) GetSourceMapIndex() int32 {
	if o == nil || IsNil(o.SourceMapIndex.Get()) {
		var ret int32
		return ret
	}
...
func (o DatasetEvent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CreatedDagruns) {
		toSerialize["created_dagruns"] = o.CreatedDagruns
	}
	if !IsNil(o.DatasetId) {
		toSerialize["dataset_id"] = o.DatasetId
	}
	if !IsNil(o.DatasetUri) {
