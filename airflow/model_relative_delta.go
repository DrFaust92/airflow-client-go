...
// checks if the RelativeDelta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelativeDelta{}
...
type _RelativeDelta RelativeDelta
...
func (o RelativeDelta) ToMap() (map[string]interface{}, error) {
...
func (o *RelativeDelta) UnmarshalJSON(data []byte) (err error) {
	...
	varRelativeDelta := _RelativeDelta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRelativeDelta)

	if err != nil {
		return err
	}

	*o = RelativeDelta(varRelativeDelta)
