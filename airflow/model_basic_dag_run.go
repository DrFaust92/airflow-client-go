...
// checks if the BasicDAGRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BasicDAGRun{}
...
func (o BasicDAGRun) ToMap() (map[string]interface{}, error) {
