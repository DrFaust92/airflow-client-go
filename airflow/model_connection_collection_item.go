...
// checks if the ConnectionCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionCollectionItem{}
...
func (o ConnectionCollectionItem) ToMap() (map[string]interface{}, error) {
