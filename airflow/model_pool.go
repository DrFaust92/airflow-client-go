...
func (o *Pool) GetDeferredSlots() int32 {
	if o == nil || IsNil(o.DeferredSlots) {
		var ret int32
		return ret
	}
...
func (o *Pool) GetOccupiedSlots() int32 {
	if o == nil || IsNil(o.OccupiedSlots) {
		var ret int32
		return ret
	}
...
func (o *Pool) GetScheduledSlots() int32 {
	if o == nil || IsNil(o.ScheduledSlots) {
		var ret int32
		return ret
	}
