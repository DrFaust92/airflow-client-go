...
// checks if the DagStatsCollectionSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DagStatsCollectionSchema{}
...
func (o *DagStatsCollectionSchema) GetDags() []DagStatsCollectionItem {
	if o == nil || IsNil(o.Dags) {
		var ret []DagStatsCollectionItem
		return ret
	}
	return o.Dags
}
...
// SetDags gets a reference to the given []DagStatsCollectionItem and assigns it to the Dags field.
func (o *DagStatsCollectionSchema) SetDags(v []DagStatsCollectionItem) {
	o.Dags = v
}

func (o DagStatsCollectionSchema) MarshalJSON() ([]byte, error) {
...
func (o DagStatsCollectionSchema) ToMap() (map[string]interface{}, error) {
...
type NullableDagStatsCollectionSchema struct {
	value *DagStatsCollectionSchema
	isSet bool
}

func (v NullableDagStatsCollectionSchema) Get() *DagStatsCollectionSchema {
	return v.value
}

func (v *NullableDagStatsCollectionSchema) Set(val *DagStatsCollectionSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableDagStatsCollectionSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableDagStatsCollectionSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDagStatsCollectionSchema(val *DagStatsCollectionSchema) *NullableDagStatsCollectionSchema {
	return &NullableDagStatsCollectionSchema{value: val, isSet: true}
}

func (v NullableDagStatsCollectionSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDagStatsCollectionSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
