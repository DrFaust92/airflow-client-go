...
type Task struct {
	...
	UiColor *string `json:"ui_color,omitempty" validate:"regexp=^#[a-fA-F0-9]{3,6}$"`
	// Color in hexadecimal notation.
	UiFgcolor *string `json:"ui_fgcolor,omitempty" validate:"regexp=^#[a-fA-F0-9]{3,6}$"`
...
func (o *Task) GetDependsOnPast() bool {
	if o == nil || IsNil(o.DependsOnPast) {
		var ret bool
		return ret
	}
...
func (o *Task) GetExecutionTimeout() TimeDelta {
	if o == nil || IsNil(o.ExecutionTimeout.Get()) {
		var ret TimeDelta
		return ret
	}
...
func (o *Task) GetExtraLinks() []TaskExtraLinksInner {
	if o == nil || IsNil(o.ExtraLinks) {
		var ret []TaskExtraLinksInner
		return ret
	}
	return o.ExtraLinks
}
...
// SetExtraLinks gets a reference to the given []TaskExtraLinksInner and assigns it to the ExtraLinks field.
...
func (o *Task) GetPriorityWeight() float32 {
	if o == nil || IsNil(o.PriorityWeight) {
		var ret float32
		return ret
	}
...
func (o *Task) GetRetryDelay() TimeDelta {
	if o == nil || IsNil(o.RetryDelay.Get()) {
		var ret TimeDelta
		return ret
	}
...
func (o *Task) GetRetryExponentialBackoff() bool {
	if o == nil || IsNil(o.RetryExponentialBackoff) {
		var ret bool
		return ret
	}
...
func (o *Task) GetWaitForDownstream() bool {
	if o == nil || IsNil(o.WaitForDownstream) {
		var ret bool
		return ret
	}
...
func (o Task) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RetryExponentialBackoff) {
