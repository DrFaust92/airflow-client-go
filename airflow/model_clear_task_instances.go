...
// checks if the ClearTaskInstances type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearTaskInstances{}
...
func (o *ClearTaskInstances) GetIncludeParentdag() bool {
	if o == nil || IsNil(o.IncludeParentdag) {
		var ret bool
		return ret
	}
...
func (o *ClearTaskInstances) GetIncludeSubdags() bool {
	if o == nil || IsNil(o.IncludeSubdags) {
		var ret bool
		return ret
	}
...
func (o ClearTaskInstances) ToMap() (map[string]interface{}, error) {
