...
// checks if the VariableCollectionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariableCollectionItem{}
...
func (o VariableCollectionItem) ToMap() (map[string]interface{}, error) {
